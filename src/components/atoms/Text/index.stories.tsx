...
ExtraSmall.args = { variant: "extraSmall", childern: longText };

export const Small = Template.bind({});
Small.args = { variant: "small", childern: longText };

export const Medium = Template.bind({});
Medium.args = { variant: "medium", childern: longText };

export const MediumLarge = Template.bind({});
MediumLarge.args = { variant: "mediumLarge", childern: longText };

export const Large = Template.bind({});
Large.args = { variant: "large", childern: longText };

export const ExtraLarge = Template.bind({});
ExtraLarge.args = { variant: "extraLarge", childern: longText };
