...
type LetterSpaceingThemeKeys = keyof typeof theme.letterSpacings;
...
export type letterSpacing = LetterSpaceingThemeKeys | (string & {});
export type lineHeight = LineHeightThemeKeys | (string & {});

// breake point
const BREAKPOINTS: { [key: stirng]: string } = {
  sm: "640px",
  md: "768px",
  lg: "1024px",
  xl: "1280px",
